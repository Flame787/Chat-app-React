...
//           const leaveMessage = `${member.clientData.username} has left the chat.`;

//           if (lastMessage && lastMessage.message.type === "user-left" && lastMessage.message.text === leaveMessage) {
//             console.log("Duplicate leave message detected, skipping...");
//             return;
//           }
